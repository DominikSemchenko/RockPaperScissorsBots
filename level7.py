...
def generate_move(prev1, prev2, data, game):
    if prev1 == 0 or prev2 == 0:
        return random.randint(1, 3)

    next_possible_moves = data[(prev2, prev1)]
...
if __name__ == "__main__":
    ...
    while True:
        ...
        move2 = generate_move(prev1, prev2, patterns_data, game)
        if move1 == "0":
            break
        if move1 == "4":
            print(patterns_data)
        ...
        if move1 == "6":
            try:
                ...
                for round_num in range(i):
                    ...
                    sim_ai_move = generate_move(prev1, prev2, patterns_data, game)
